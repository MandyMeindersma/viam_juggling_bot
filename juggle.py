...
class Juggler:
    ...
    async def zero(self):
        ...
        await self.arm.move_to_joint_positions(JointPositions(values=[43.91, -115.07, -215.38, 5.55, 32.72, -11.52]))
    ...
    async def throw(self):
        """Zero out all the joints, returning the arm to a flat, outstretched position."""
        await self.arm.move_to_joint_positions(JointPositions(values=[43.91, -85, -215.38, 5.55, 32.72, -11.52]))
